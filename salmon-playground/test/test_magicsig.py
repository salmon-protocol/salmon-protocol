...
class TestMagicEnvelopeProtocol(unittest.TestCase):
  ...
  test_atom = """<?xml version='1.0' encoding='UTF-8'?>
    ...
    <id>tag:example.com,2009:cmt-0.44775718</id>
      <author><name>test@example.com</name><uri>acct:test@example.com</uri></author>
  ...
  test_atom_multi_author = """<?xml version='1.0' encoding='UTF-8'?>
    <entry xmlns='http://www.w3.org/2005/Atom'>
    <id>tag:example.com,2009:cmt-0.44775718</id>
      <author><name>alice@example.com</name><uri>acct:alice@example.com</uri></author>
      <author><name>bob@example.com</name><uri>acct:bob@example.com</uri></author>
      <content>Salmon swim upstream!</content>
      <title>Salmon swim upstream!</title>
      <updated>2009-12-18T20:04:03Z</updated>
    </entry>
  ...
  def testNormalizeUserIds(self):
    ...
    self.assertEquals(magicsig._NormalizeUserIdToUri(id1), id1)
    self.assertEquals(magicsig._NormalizeUserIdToUri(id2), id2)
    self.assertEquals(magicsig._NormalizeUserIdToUri(id3), id3)
    self.assertEquals(magicsig._NormalizeUserIdToUri(em3), id3)
    self.assertEquals(magicsig._NormalizeUserIdToUri(' '+id1+' '), id1)
